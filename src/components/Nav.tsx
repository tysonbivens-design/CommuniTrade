...
const locationIcon = locationMode === ‘current’ ? ‘📡’ : ‘📍’
...
>
{fetchingGPS ? ‘Locating…’ : ‘📡 Current’}
</button>
</div>
) : null

const bottomTabs: { page: Page; label: string; icon: string }[] = user
? [
{ page: ‘home’,          label: ‘Home’,    icon: ‘🏠’ },
{ page: ‘library’,       label: ‘Library’, icon: ‘📚’ },
{ page: ‘barter’,        label: ‘Barter’,  icon: ‘🤝’ },
{ page: ‘loans’,         label: ‘Loans’,   icon: ‘📦’ },
{ page: ‘notifications’, label: ‘Alerts’,  icon: ‘🔔’ },
]
: [
{ page: ‘home’,    label: ‘Home’,    icon: ‘🏠’ },
{ page: ‘library’, label: ‘Library’, icon: ‘📚’ },
        ...
        {pillOpen && user && (
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
              <span style={{ fontSize: '0.88rem', color: 'var(--bark)' }}>{locationIcon} {displayLabel}</span>
            ...
            <p style={{ fontSize: '0.75rem', color: 'var(--muted)', marginTop: '0.6rem', textAlign: 'center' }}>
              Library and Barter filter to this range
            </p>
          </div>
        )}
      </div>
